      ...
      <div className="w-full max-w-md bg-white p-8 rounded-2xl shadow-lg text-center animate-in fade-in zoom-in duration-300">
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          <div className="flex justify-between gap-2">
            {otp.map((data, index) => (
              <input
                ...
                className="w-12 h-14 text-center text-2xl font-bold border-2 border-border-main rounded-xl focus:border-theme-primary focus:ring-1 focus:ring-theme-primary outline-none transition-all"
              />
            ))}
          </div>
          ...
          <button
            ...
            className="w-full bg-theme-primary text-white font-semibold py-3 rounded-xl shadow-md hover:bg-theme-primary-dark transition-all disabled:opacity-50"
          >
        ...
        <div className="mt-8 pt-6 border-t border-border-main">
          ...
          <button
            ...
            disabled={loading}
            className="flex items-center justify-center mx-auto text-theme-primary font-medium hover:text-theme-primary-dark transition-colors"
          >
